  ...
  return (
    ...
    >
      ...
      >
        ...
        user-friendly web applications. I work with Next.js, React, Node.js,
        Express, and MongoDB, combining modern front-end design with reliable
        back-end systems. I enjoy turning ideas into products that are clean,
      ...
      >
        ...
        <Button variant="outline" size="icon" asChild>
          <Link
            href="https://www.linkedin.com/in/suprodip-bhattacharjee1611/"
            aria-label="Linkedin"
            target="_blank"
          >
